...
GRAPHS = {
  azertyMac: adjacency_graphs.azertyMac,
  azertyPC: adjacency_graphs.azertyPC,
...
matching = {
  ...
  SHIFTED_RX2: /[#1234567890°_AZERTYUIOP¨*QSDFGHJKLM%£>WXCVBN?./+]/,
  spatial_match_helper: function (password, graph, graph_name) {
    ...
    while (i < password.length - 1) {
      ...
      if ((graph_name === "qwerty" || graph_name === "dvorak") && this.SHIFTED_RX.exec(password.charAt(i))) {
        ...
        (graph_name === "azertyMac" || graph_name === "azertyPC") &&
        this.SHIFTED_RX2.exec(password.charAt(i))
      ) {
        shifted_count = 1;
      } else {
        shifted_count = 0;
