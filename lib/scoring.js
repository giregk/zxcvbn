...
scoring = {
  ...
  KEYBOARD_AVERAGE_DEGREE2: calc_average_degree(adjacency_graphs.azertyMac),
  ...
  KEYBOARD_STARTING_POSITIONS2: (function () {
    var ref, results;
    ref = adjacency_graphs.azertyMac;
    results = [];
    for (k in ref) {
      v = ref[k];
      results.push(k);
  ...
  spatial_guesses: function (match) {
    ...
    } else if ((ref = match.graph) === "azertyMac" || ref === "azertyPC") {
      s = this.KEYBOARD_STARTING_POSITIONS2;
      d = this.KEYBOARD_AVERAGE_DEGREE2;
    } else {
